        ...
        <div className="flex flex-col gap-3 w-full xl:max-w-[490px]">
          ...
          <div className="flex flex-col gap-y-4 text-white text-base md:text-xl xl:text-2xl">
            ...
            <p>
              ...
              Burna, experience various pop-up moments such as the Giza Grocery
              & City Boy Cuts, as well as shop around for ‘I Told Them’ merch.
              Check out the recap video and photo gallery!
            </p>
          </div>
        </div>
