      ...
      {isOpen && (
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <div className="absolute w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
            <div className="place-items-center text-center text-white mt-5">
              <h3 className="font-bold md:text-4xl text-base ">
                Subscribe <br /> For Burna Boy <br />
                Updates
              </h3>
            </div>
            <div className="flex flex-col gap-1 items-center my-5">
              <div className="flex place-content-center w-full ">
                <input
                  type="email"
                  placeholder="EMAIL"
                  className="border-2  px-2 text-white bg-inherit border-white   focus:outline-none w-100 min-w-[200px] md:max-w-[500px] rounded-l-lg"
                />
